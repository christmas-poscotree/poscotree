		...
		<div class="root">
			...
			<div class='bform'>
				<button type="submit" class="log"
					...
					style="cursor: pointer;">편지 확인하기</button>
				<button type="submit" class="sign" onClick="copyUrl()"
					style="cursor: pointer;">트리링크 복사하기</button>
			...
			<div class='bform'>
				...
				<button type="submit" class="sign" onClick="location.href='/'"
					style="cursor: pointer;">나도 트리 만들래!</button>
			</div>
			<%
			...
			<div class='bform'>
				<button type="submit" class="sign"
					onClick="location.href='/tree/<%=treeNo%>/MessageForm'"
					style="cursor: pointer;">트리 꾸며주기</button>
				<button type="submit" class="log" onClick="location.href='/login'"
					style="cursor: pointer;">내 트리로 가기</button>
			</div>
			<%
			}
			%>
